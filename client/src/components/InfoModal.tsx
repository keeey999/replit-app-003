  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-cinzel text-primary dark:text-secondary">錬成陣について</DialogTitle>
        </DialogHeader>
        
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <h3 className="text-primary dark:text-secondary font-cinzel">錬成陣とは</h3>
          <p>
            錬成陣（<em>れんせいじん</em>）は、神秘的な力を秘めた幾何学的な図形です。様々な文化において、これらの図形は特別な力や意味を持つとされてきました。
          </p>
          
          <h3 className="text-primary dark:text-secondary font-cinzel mt-4">デザイン要素</h3>
          ...
          <h3 className="text-primary dark:text-secondary font-cinzel mt-4">神秘の法則</h3>
